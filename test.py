...
tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8 = st.tabs(["📊 Ligatabel", "📅 Kampe", "📈 Udvikling", "🏆 Intern tabel", "🧮 Akkumuleret liga", "Stats", "xT", "xG xml"])
        ...
        for shot in shot_events:
            ...
            if xg_val is not None:
                ...
                if shot["period"] == 1:
                    ...
                    adjusted_seconds = kickoff2_secs + (raw_seconds - 45 * 60)
                else:
